...
def render_ict_panel(analysis):
    ...
    # 3. HTML OLUŞTURMA (TEXTWRAP KULLANILDI, GİRİNTİLER TEMİZLENDİ)
    # Streamlit'in HTML'i kod bloğu olarak algılamaması için 'textwrap.dedent' kritik.
