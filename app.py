...
with col_left:
    ...
    with st.expander("Ajan Operasyonlarını Yönet", expanded=True):
        ...
        if st.session_state.stp_scanned or (st.session_state.accum_data is not None):
            ...
            with c2:
                st.markdown("<div style='text-align:center; color:#b91c1c; font-weight:700; font-size:0.8rem; margin-bottom:5px;'>🎯 STP KESTİ-20<RSI<70-SMA200 ÜSTÜ</div>", unsafe_allow_html=True)
                with st.container(height=200, border=True):
